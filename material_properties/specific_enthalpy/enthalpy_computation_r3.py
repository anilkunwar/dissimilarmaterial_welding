...
def create_enhanced_visualization(df, composition, material_name="Alloy", customizations=None, Tm=None):
    ...
    # Enhanced label placement with padding
    ...
    ax1.legend(loc=legend_location, fontsize=legend_font_size, framealpha=0.9,
              bbox_to_anchor=(0.5, -0.15) if legend_location == 'best' else None)
    
    # Set tick parameters with improved size and padding
    ax1.tick_params(axis='both', which='major', labelsize=tick_size, pad=8)
    ax1.tick_params(axis='both', which='minor', labelsize=tick_size-2, pad=6)
    ...
    # Set tick parameters
    ax2.tick_params(axis='both', which='major', labelsize=tick_size, pad=8)
    ax2.tick_params(axis='both', which='minor', labelsize=tick_size-2, pad=6)
    ...
    fig.text(0.5, 0.02, f'Composition: {comp_text}', 
             ha='center', fontsize=font_size-1, style='italic', alpha=0.8, fontweight='medium')
    
    # Add statistics box with improved padding
    stats_text = f"""
    Statistics:
    ...
    fig.text(0.02, 0.98, stats_text, transform=fig.transFigure,
             ...
             bbox=dict(boxstyle='round', facecolor='wheat', alpha=0.7, pad=10, linewidth=1.5))
